...
(function($) {
  ...
  $.fn.expander = function(options) {
    ...
    function changeSlicePoint(info) {
      ...
      var sliceOnIndex = info.summaryText.indexOf(info.sliceOn);

      // Base condition off of true sliceOn location
      if (sliceOnIndexClean !== -1 && sliceOnIndexClean < info.slicePoint) {
        // do normal slicePoint
        info.slicePoint = sliceOnIndex;
        info.summaryText = info.allHtml.slice(0, info.slicePoint);
      }
      return info;
    }
