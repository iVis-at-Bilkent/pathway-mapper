...
export default class ChatBox extends React.Component<ChatMessageProps>{
  ...
  render() {  
    ...
    let MyMessageColors = ['#1e90ff', '#ff0000', '#effd00', '#006400', '#0000ff', '#257359', '#c71585', '#fd713d']; 
    let OthersMessageColors = ['#8ec7fe', '#f08c8c', '#f6f7b6', '#31ff31', '#a1a1f7', '#b2e5d4', '#f17bc5', '#fdb89e' ]; 
    return (
